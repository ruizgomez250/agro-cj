...
export default function Create() {
    ...
    return (
        <AuthenticatedLayout
            header={<h2 className="text-xl font-semibold text-gray-800">Nuevo Proveedor</h2>}
        >
                        ...
                        <form onSubmit={submit} className="p-6 space-y-6">
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <input type="text" value={data.especialidad} onChange={(e) => setData('especialidad', e.target.value)} className={inputClass('especialidad')} placeholder="Ej: fertilizantes, combustibles..." />
