...
export default function Edit({ compra, proveedores, cultivos, tiposInsumo, unidades, productos }) {
    const insumoData = compra.insumos?.[0] || {};
    const gasoilData = compra.recepciones_gasoil?.[0] || {};

    const { data, setData, put, processing, errors } = useForm({
        fecha: compra.fecha?.split('T')[0] || '',
        tipo: compra.tipo || 'general',
        ...
        insumo_nombre: insumoData.nombre || '',
        insumo_tipo: insumoData.tipo || '',
        insumo_cantidad: insumoData.cantidad || '',
        insumo_unidad: insumoData.unidad || '',
        insumo_costo_unitario: insumoData.costo_unitario || '',
        insumo_cultivo_id: insumoData.cultivo_id || '',
        gasoil_guia_remision: gasoilData.guia_remision || '',
        gasoil_cantidad_galones: gasoilData.cantidad_galones || '',
        gasoil_precio_galon: gasoilData.precio_galon || '',
        producto_id: compra.producto_id || '',
        producto_cantidad: compra.producto_cantidad || '',
    });
    ...
    return (
        <AuthenticatedLayout
            header={<h2 className="text-xl font-semibold text-gray-800">Editar Compra</h2>}
        >
                        ...
                        <form onSubmit={submit} className="p-6 space-y-6">
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                                ...
                                <div className="sm:col-span-2">
                                    ...
                                    <input type="text" value={data.descripcion} onChange={(e) => setData('descripcion', e.target.value)} className={inputClass('descripcion')} />
                                ...
                                <div className="border-t border-gray-200 pt-6 space-y-6">
                                    ...
                                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                                        <div className="sm:col-span-2">
                                            ...
                                            <input type="text" value={data.insumo_nombre} onChange={(e) => setData('insumo_nombre', e.target.value)} className={inputClass('insumo_nombre')} />
                            ...
                            <div className="flex items-center justify-end gap-3 pt-4 border-t border-gray-100">
                                ...
                                <button type="submit" disabled={processing} className="px-4 py-2 text-sm font-medium text-white bg-emerald-600 hover:bg-emerald-700 rounded-lg shadow-sm transition disabled:opacity-50">
                                    {processing ? 'Actualizando...' : 'Actualizar Compra'}
                                </button>
                            </div>
                        </form>
                    </div>
