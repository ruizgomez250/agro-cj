...
export default function Create({ lotes }) {
        ...
        <AuthenticatedLayout
            header={
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <h2 className="text-xl font-semibold text-gray-800">Nuevo Cultivo</h2>
                        <p className="text-sm text-gray-500 mt-0.5">Registrar un nuevo cultivo en el sistema</p>
                    </div>
                </div>
            }
        >
            <Head title="Nuevo Cultivo" />
