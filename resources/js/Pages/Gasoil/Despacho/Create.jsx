...
export default function Create({ recepciones }) {
    ...
    const submit = (e) => {
        e.preventDefault();
        post(route('gasoil.despacho.store'));
    };
    ...
    return (
        <AuthenticatedLayout
            header={
                <div>
                    <h2 className="text-xl font-semibold text-gray-800">Nuevo Despacho</h2>
                    <p className="text-sm text-gray-500 mt-0.5">Registrar un nuevo despacho de gasoil</p>
                </div>
            }
        >
            <Head title="Nuevo Despacho de Gasoil" />
                    ...
                    <div className="bg-white rounded-xl shadow-md overflow-hidden">
                        ...
                        <form onSubmit={submit} className="p-6 space-y-6">
                            ...
                            <div className="flex items-center justify-end gap-3 pt-4 border-t border-gray-100">
                                ...
                                >
                                    {processing ? 'Guardando...' : 'Guardar Despacho'}
                                </button>
                            </div>
                        </form>
                    </div>
