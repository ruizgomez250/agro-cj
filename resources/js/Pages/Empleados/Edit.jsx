...
export default function Edit({ empleado }) {
    ...
    return (
        <AuthenticatedLayout
            header={<h2 className="text-xl font-semibold text-gray-800">Editar Empleado</h2>}
        >
                        ...
                        <form onSubmit={submit} className="p-6 space-y-6">
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <input type="text" value={data.cargo} onChange={(e) => setData('cargo', e.target.value)} className={inputClass('cargo')} />
